            ...
            while True:
                ...
                if self.ser.in_waiting > 0:
                    ...
                    if self.trigger == "detectar":
                        ...
                        tamanho_minimo_contorno = 500

                        # Desenhar retângulos ao redor das áreas detectadas (apenas se o contorno for grande o suficiente)
                        if contours_azul:
                            for cnt in contours_azul:
                                area = cv2.contourArea(cnt)
                                if (
                                    area > tamanho_minimo_contorno
                                ):  # Verifica se o contorno é maior que o mínimo
